...
public class BOSE6 implements Method {
    ...
    public class BOSEAccount implements MethodAccount {
        ...
        public double balance() {
            return Double.valueOf(this.BOSEconomy.getPlayerMoneyDouble(this.name));
        }
    ...
    public class BOSEBankAccount implements MethodBankAccount {
        ...
        public double balance() {
            return Double.valueOf(this.BOSEconomy.getBankMoneyDouble(name));
        }

        public boolean set(double amount) {
            return this.BOSEconomy.setBankMoney(name, amount, true);
        }

        public boolean add(double amount) {
            return this.BOSEconomy.setBankMoney(this.name, (balance() + amount), false);
        }

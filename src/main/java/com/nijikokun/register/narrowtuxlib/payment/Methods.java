...
public class Methods {
    ...
    private static void _init() {
        addMethod("iConomy", new com.nijikokun.register.narrowtuxlib.payment.methods.iCo6());
        addMethod("iConomy", new com.nijikokun.register.narrowtuxlib.payment.methods.iCo5());
        addMethod("iConomy", new com.nijikokun.register.narrowtuxlib.payment.methods.iCo4());
        addMethod("BOSEconomy", new com.nijikokun.register.narrowtuxlib.payment.methods.BOSE6());
        addMethod("BOSEconomy", new com.nijikokun.register.narrowtuxlib.payment.methods.BOSE7());
        addMethod("Essentials", new com.nijikokun.register.narrowtuxlib.payment.methods.EE17());
        addMethod("Currency", new com.nijikokun.register.narrowtuxlib.payment.methods.MCUR());
        addMethod("3co", new com.nijikokun.register.narrowtuxlib.payment.methods.ECO3());
